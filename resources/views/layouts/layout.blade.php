                    ...
                    <ul class="navbar-nav ms-auto" style="flex-direction: unset;gap: 8px;">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                                <!-- <li>
                                    <a class="dropdown-item" id='en' onclick="langChange('en')">{{__('EN')}}</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" id='zh-CN' onclick="langChange('zh_CN')">{{__('简中')}}</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" id='ms' onclick="langChange('ms')">{{__('BM')}}</a>
                                </li> -->
                                <li>
                                    <a class="dropdown-item" id='en' href="{{ url('set-locale/en') }}">{{__('EN')}}</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" id='zh-CN' href="{{ url('set-locale/zh_CN') }}">{{__('简中')}}</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" id='ms' href="{{ url('set-locale/ms') }}">{{__('BM')}}</a>
                                </li>
                            </ul>
                        </li>
